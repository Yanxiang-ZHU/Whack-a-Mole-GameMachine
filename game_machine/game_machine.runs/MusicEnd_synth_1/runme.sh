...
HD_PWD='C:/Users/39551/Desktop/ASIC/Whack-a-Mole-GameMachine/game_machine/game_machine.runs/MusicEnd_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MusicEnd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MusicEnd.tcl
