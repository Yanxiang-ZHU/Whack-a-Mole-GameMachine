...
HD_PWD='C:/Users/39551/Desktop/ASIC/Whack-a-Mole-GameMachine/game_machine/game_machine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GameTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GameTop.tcl -notrace
