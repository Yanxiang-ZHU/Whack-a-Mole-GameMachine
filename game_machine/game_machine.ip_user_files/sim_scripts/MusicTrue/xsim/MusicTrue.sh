...
#
# Script generated by Vivado on Mon Apr 14 14:55:38 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : MusicTrue.sh
...
#
# Usage        : MusicTrue.sh
#                MusicTrue.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                MusicTrue.sh [-reset_run]
#                MusicTrue.sh [-reset_log]
#                MusicTrue.sh [-help]
#
...
# script info
echo -e "MusicTrue.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./MusicTrue.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot MusicTrue xil_defaultlib.MusicTrue xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim MusicTrue -key {Behavioral:sim_1:Functional:MusicTrue} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb MusicTrue.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./MusicTrue.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: MusicTrue.sh [-help]\n\
Usage: MusicTrue.sh [-step]\n\
Usage: MusicTrue.sh [-lib_map_path]\n\
Usage: MusicTrue.sh [-reset_run]\n\
Usage: MusicTrue.sh [-reset_log]\n\
Usage: MusicTrue.sh [-keep_index]\n\
Usage: MusicTrue.sh [-noclean_files]\n\n\
