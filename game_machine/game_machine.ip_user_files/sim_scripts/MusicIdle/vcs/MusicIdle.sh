...
#
# Script generated by Vivado on Tue Apr 15 20:53:33 +0800 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : MusicIdle.sh
...
#
# Usage        : MusicIdle.sh
#                MusicIdle.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                MusicIdle.sh [-reset_run]
#                MusicIdle.sh [-reset_log]
#                MusicIdle.sh [-help]
#
...
#                script (type 'MusicIdle.sh -help' for more information).
#
...
# script info
echo -e "MusicIdle.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./MusicIdle.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.MusicIdle xil_defaultlib.glbl -o MusicIdle_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./MusicIdle_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key MusicIdle_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc MusicIdle_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./MusicIdle.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: MusicIdle.sh [-help]\n\
Usage: MusicIdle.sh [-step]\n\
Usage: MusicIdle.sh [-lib_map_path]\n\
Usage: MusicIdle.sh [-reset_run]\n\
Usage: MusicIdle.sh [-reset_log]\n\
Usage: MusicIdle.sh [-keep_index]\n\
Usage: MusicIdle.sh [-noclean_files]\n\n\
